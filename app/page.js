export default function AstroviaEnterpriseWebsite() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-slate-950 text-white">
      <div className="fixed inset-0 -z-10 bg-astro-background" />
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        <div className="grid items-center gap-14 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="animate-fadeInUp">
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-slate-300 animate-fadeInUpDelay1">
              Astrovia Enterprise delivers modern software, fintech integrations,
              and IT support for businesses.
            </p>

            <div className="mt-6 inline-flex items-center rounded-full border border-white/10 bg-white/5 px-5 py-2 text-sm text-blue-100 backdrop-blur-sm animate-fadeInUpDelay2">
              Software Excellence. IT Support at Warp Speed.
            </div>

            <div className="mt-8 flex flex-wrap gap-4 animate-fadeInUpDelay3">
              <a
                href="#contact"
                className="rounded-xl bg-blue-500 px-6 py-3 font-semibold transition hover:scale-[1.03] hover:bg-blue-400"
              >
                Get Started
              </a>
              <a
                href="#services"
                className="rounded-xl border border-white/20 px-6 py-3 transition hover:scale-[1.03] hover:bg-white/5"
              >
                Our Services
              </a>
            </div>
          ...
          <div className="relative animate-floatIn">
              ...
              <div className="relative flex min-h-[420px] items-center justify-center rounded-[1.5rem] border border-white/10 bg-gradient-to-br from-slate-900 via-blue-950 to-slate-950">
                ...
                <div className="relative flex items-center justify-center">
                  ...
                  <img
                    src="/logo.png"
                    alt="Astrovia Logo"
                    className="relative z-10 h-44 w-44 object-contain animate-softPulse drop-shadow-[0_0_40px_rgba(59,130,246,0.35)]"
                  />
                </div>
                ...
                <div className="absolute bottom-6 left-6 right-6 grid grid-cols-2 gap-3">
                  ...
                  <div className="rounded-2xl border border-white/10 bg-slate-950/50 p-4 transition hover:-translate-y-1 hover:bg-white/10">
                    ...
                    <div className="mt-1 text-xs text-slate-400">
                      Reliable support and execution.
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <div className="rounded-[2rem] border border-white/10 bg-white/5 p-8 backdrop-blur-md transition hover:border-blue-300/20">
            ...
            <p className="mt-4 max-w-2xl text-slate-300">
              Astrovia Enterprise is a technology company focused on software
              solutions, IT support, and digital systems that help businesses
              grow.
            </p>
          </div>
          ...
          <div className="rounded-[2rem] border border-white/10 bg-gradient-to-br from-blue-500/10 to-white/5 p-8 backdrop-blur-md transition hover:border-blue-300/20">
            <p className="leading-8 text-slate-300">
              We combine practical execution with a futuristic identity, helping
              businesses move faster through smart systems, secure support, and
